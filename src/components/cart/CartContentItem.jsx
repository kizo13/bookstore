  ...
  render() {
    return (
      <div className="cart-item">
        ...
        {this.props.book.published && <span className="published-date"><i className="fa fa-calendar" aria-hidden="true"></i> <b>Published date:</b> {this.props.book.published}</span>}
